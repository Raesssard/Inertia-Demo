                    ...
                    {posts.data.length > 0 ? (
                        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6">
                            {posts.data.map((post) => (
                                <div
                                    key={post.id}
                                    className="bg-white rounded shadow hover:shadow-lg transition overflow-hidden flex flex-col justify-between h-full"
                                >
                                    <Link href={`/posts/${post.id}`}>
                                        ...
                                        <div className="p-4">
                                            ...
                                            <p className="text-xs text-gray-500 mt-2">Kategori: {post.category?.name ?? '-'}</p>
                                        </div>
                                    </Link>
